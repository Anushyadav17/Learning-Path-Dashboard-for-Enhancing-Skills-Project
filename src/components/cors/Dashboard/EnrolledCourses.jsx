...
import {getUserCourses as getUserEnrolledCourses}  from "../../../services/opreations/profileAPI"
...
const EnrolledCourses = () => {
    ...
    const getEnrolledCourses = async() => {
        setLoading(true);
            ...
            setLoading(false);
            setEnrolledCourses(response?.course);
  ...
  return (
    <div className='mx-auto w-11/12 max-w-[1000px] py-10'>
        ...
        <div className='text-3xl text-black'>Enrolled Courses</div>
        {
            ...
            : !enrolledCourses.length ? (<p className='grid h-[10vh] w-full place-content-center text-richblack-500'>You have not enrolled in any course yet</p>)
            : (
                            ...
                            <div key={index} onClick={()=>{
                                ...
                                <div className='flex w-[45%] cursor-pointer items-center gap-4 px-5 py-3'>
                                    ...
                                    <div className='flex max-w-xs flex-col gap-2'>
                                        ...
                                        <p className='text-xs text-richblack-500 hidden md:block'>{
                                ...
                                <div className='flex w-1/5 flex-col gap-2 px- py-3 text-black'>
                                    {
                                        progressData?.map((progress,index)=> {
                                            ...
                                            if(progress?.courseID === course?._id) {
                                                return (
                                                    <div key={index}>
                                                        <p className='text-black'>Completed: {progress?.completedVideos?.length} / {totalNoOfLectures(course)}</p>
                                                        <ProgressBar
